...
Thread::Fork(VoidFunctionPtr func, void *arg)
{
    ...
    // 設定 interrupt 裡的 level 為 IntOff， level 表 interrupt 為 enable 或 disable
    // 因跑 ReadyToRun() 要將 Level 設為 IntOff 
    // 並將原本的 level 暫存到 oldLevel

    /***************************************/
    // cout << "\tIn Thread::Fork" << endl;
    // cout << "\t\tthis.name : ";
    // this->Print();
    // cout << endl;
    /***************************************/
    ...
    // 這個 this 是指某一個 t[threadNum]
    // ReadyToRun() 用來添加 Ready_List

    (void) interrupt->SetLevel(oldLevel);
    // 做完將 ReadyToRun()，將 interrupt 的 level 設為原本的 level
    /**********************************************/
}    
...
Thread::Finish ()
{
    // cout << "In Finish , currectThread = " << kernel->currentThread->getName() << endl;
    /*********************************************/
    (void) kernel->interrupt->SetLevel(IntOff);		
    // cout << "In Finish , currectThread = " << kernel->currentThread->getName() << endl;
    // 將 interrupt 的 Level 設為 IntOff，因 Sleep() 的要求
    /*********************************************/
...
Thread::Sleep (bool finishing)
{
    ...
    /********************************/
    status = BLOCKED;
    // 將 currectThread 的 status 設為 BLOCKED
    /********************************/
    // cout << "In Sleep , currectThread = " << kernel->currentThread->getName() << endl;
    ...
    // FinNextToRun() : 從 Ready_List (資料型態為 linked_list)，取出下一個要執行的 Thread
    // cout << "In Sleep , currectThread = " << kernel->currentThread->getName() << endl;
    // cout << "\tSleep_flag = " << finishing << endl;
    // cout<< "\tcurrent_Thread = " << kernel->currentThread->getName() << endl;
    // cout << "\tnext_Thread = " << nextThread->getName() << endl;
    // cout << "In Thread::Sleep , after call FindNextToRun()" << endl;
    // kernel->scheduler->Print();
    // cout << endl;
    /**********************************************************************/
